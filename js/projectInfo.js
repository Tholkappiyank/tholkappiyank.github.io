const Projects = {
    Details:{//adding in opposite-chronological order, so it's easy to add later    
		...
		Platformer2D: {
            ...
            LargeDescription: '<b>Android Platform - Game </b> <br><br> • Reverse Engineering of Mario Game to understand the Game mechanics and 2D level design features (Tile System) available on Unity3D for Android platform. <br>• A hobby project to understand the mechanics - move, jump, hit, shoot the enemy. ',
            DownloadLink: "",
        ...
        MusicalBall3D: {
            ID: "MusicalBall3D",
            Name: "Hyper Casual / Musical Ball 3D",
            SmallDescription: "Unity3D, C#, 3D Music Game",
            LargeDescription: "<b>Musical Ball 3D</b> <br><br> • A rhythm-based music ball game — hop, jump, and bounce through the beat <br> • Survive by hitting and smashing music tiles to the rhythm <br> • Enjoy dynamic soundscapes that react to your every move <br> • Easy one-tap controls with increasing speed and challenge <br> • Test your reflexes — what's your best score?",
            DownloadLink: "",
        ...
        BreakBreaker3D: {
            ID: "BreakBreaker3D",
            Name: "Hyper Casual / Brick Breaker 3D: Food Puzzle",
            SmallDescription: "Unity3D, C#, Hyper Casual, Food Puzzle",
            LargeDescription: "<b>Brick Breaker 3D: Food Puzzle</b> <br><br> • Classic brick breaker with a food puzzle twist — expanded gameplay you've never seen before <br> • Free to play — aim & hit to drop and burst all colorful bricks <br> • Acquire and upgrade amazing power-ups to tackle harder stages <br> • Unlock different paddles and balls to beat high scores <br> • Immersive 3D environment with engaging controls — a fresh take on brick breaker",
            DownloadLink: "",
            EmbedVideoLinkID: "cHX2ARssc74",
            NoOfProjectImages: 5,
            CarouselWidth: 75,
            ShowSlider: false
        },
